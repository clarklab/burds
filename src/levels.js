...
export const LEVELS = [
  {
    ...
    build: buildWorld,
    howto: [
      { icon: 'swipe', html: 'Drag to <b>strafe</b> &amp; dive — line up under a target' },
      { icon: 'turd', html: '<b>Hold</b> to grow a bigger turd, <b>release</b> when the reticle hones tight' },
      { icon: 'bolt', html: 'Dead-center = <b>bullseye</b>; bomb the gold <b>SUPER TURD</b> for giant turds' },
    ],
  },
  {
    id: 'wedding',
    ...
    howto: [
      { icon: 'swipe', html: 'Auto-pilot the aisle — <b>steer</b> &amp; dive to aim' },
      { icon: 'turd', html: '<b>Hold</b> for a huge turd that <b>splashes whole rows</b>' },
      { icon: 'church', html: '<b>Couple &amp; priest</b> score <b>double</b>; gold <b>SUPER TURD</b>s = giant turds' },
    ],
  },
  {
    id: 'concert',
    ...
    howto: [
      { icon: 'swipe', html: 'Auto-pilot the pit — <b>steer</b> &amp; dive to aim' },
      { icon: 'turd', html: '<b>Hold</b> for a giant turd that <b>splashes a mosh of fans</b>' },
      { icon: 'music', html: '<b>Band</b> scores <b>double</b>; gold <b>SUPER TURD</b>s = total mayhem' },
    ],
  },
];
